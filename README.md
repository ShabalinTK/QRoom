...
| **FR‑2** | Генерация QR | Система генерирует уникальный QR-код с временным токеном, обновляющимся каждые 5 секунд |
...
|-----|-----------|------------|
| **NFR‑1** | Security | Срок жизни (TTL) динамического токена в QR-коде — **5 секунд** |
